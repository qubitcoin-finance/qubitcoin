...
<ul class="text-text-secondary text-sm leading-relaxed mb-3 list-disc list-inside space-y-1">
  ...
  <li><span class="text-text-primary font-medium">Node wallet persists</span> — the mining wallet generated by <span class="font-mono text-xs text-qubit-400">qbtcd --mine</span> is saved to <span class="font-mono text-xs text-qubit-400">wallet.json</span> in the data directory and reused after restarts.</li>
