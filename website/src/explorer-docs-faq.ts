...
${docFaqItem('Which BTC address types are supported?',
  'Currently supported: <span class="text-text-primary font-medium">P2PKH</span> (1...), <span class="text-text-primary font-medium">P2PK</span> (raw pubkey), <span class="text-text-primary font-medium">P2WPKH</span> (bc1q...), <span class="text-text-primary font-medium">P2SH-P2WPKH</span> (3...), <span class="text-text-primary font-medium">P2SH multisig</span> (3...), <span class="text-text-primary font-medium">P2TR</span> (bc1p...), <span class="text-text-primary font-medium">P2WSH</span> (bc1q... long), and <span class="text-text-primary font-medium">bare multisig</span> (SHA256(script)). See <a href="#/docs/btc-claims" class="text-qubit-400 hover:text-qubit-300">BTC Claims</a> for details.')}
