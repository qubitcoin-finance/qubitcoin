...
${docFaqItem('Which BTC address types are supported?',
  'Currently supported: <span class="text-text-primary font-medium">P2PKH</span> (1...), <span class="text-text-primary font-medium">P2PK</span> (raw pubkey), <span class="text-text-primary font-medium">P2WPKH</span> (bc1q...), <span class="text-text-primary font-medium">P2SH-P2WPKH</span> (3...), <span class="text-text-primary font-medium">P2SH multisig</span> (3...), <span class="text-text-primary font-medium">P2TR</span> (bc1p...), <span class="text-text-primary font-medium">P2WSH</span> (bc1q... long), and <span class="text-text-primary font-medium">bare multisig</span> (raw script hash). See <a href="#/docs/btc-claims" class="text-qubit-400 hover:text-qubit-300">BTC Claims</a> for details.')}
...
${docFaqItem('How does the snapshot merkle root work?',
  'The snapshot commitment is a double-SHA256 over the ordered address-balance entries, including script type tags when present. It\'s committed in the genesis block\'s coinbase, so any node can recompute it from the snapshot file and verify it matches genesis.')}
</div>
