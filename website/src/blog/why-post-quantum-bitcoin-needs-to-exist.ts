...
${p('BTC holders can prove ownership of their address balance with a one-time Bitcoin ownership proof and claim the equivalent QBTC balance into a new ML-DSA-65 keypair. After that, all transactions are quantum-safe. The Bitcoin proof is only used once — to migrate, not to transact.')}
